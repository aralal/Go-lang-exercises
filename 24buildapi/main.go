...
func main() {
	...
	//seeding
	courses = append(courses, Course{CourseId: "2", CourseName: "ReactJS", CoursePrice: 299, Author: &Author{Fullname: "Aravind Lal", Website: "lco.dev"}})
	courses = append(courses, Course{CourseId: "4", CourseName: "Angular", CoursePrice: 399, Author: &Author{Fullname: "Aravind Lal", Website: "go.dev"}})
...
func getAllcourses(w http.ResponseWriter, r *http.Request) {
	...
	w.Header().Set("Content-Type", "applicattion/jason")
...
func deleteOneCourse(w http.ResponseWriter, r *http.Request) {
	...
	for index, course := range courses {
		if course.CourseId == params["id"] {
			courses = append(courses[:index], courses[index+1:]...)
			//TODO : send a confirm or deny request
			break
		}
	}
